...
namespace penguin
{
public class StageDetection_TimeLimit_fish : MonoBehaviour
{
    ...
    GameManager_TimeLimit_fish GameManager_TimeLimit;
    ...
    void Start()
    {
        ...
        GameManager_TimeLimit=GameManagerObj.GetComponent<GameManager_TimeLimit_fish>();
    ...
    private IEnumerator gameOver() 
    {
        ...
        SceneManager.LoadScene("Penguin(fish)_TimeLimit_Score");
    }
    void gameover()
    {   
        _missSound.Play();
