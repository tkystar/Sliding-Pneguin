...
namespace penguin
{
public class GoalDetection_scroll : MonoBehaviour
{
    public static bool gameFin;
    public GameObject GameManager;
    GameManager_scroll _gameManager;
    ...
    */
    ...
    void Start()
    {
        ...
        _gameManager=GameManager.GetComponent<GameManager_scroll>();
 ...
 */     
    ...
    private IEnumerator gameClear() 
    {
        ...
        SceneManager.LoadScene("Penguin_Score_scroll");
    }
