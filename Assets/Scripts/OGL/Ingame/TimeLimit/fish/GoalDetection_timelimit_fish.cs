...
namespace penguin
{
public class GoalDetection_timelimit_fish : MonoBehaviour
{
    public static bool gameFin;
    public GameObject GameManager;
    GameManager_TimeLimit_fish _gameManager;
    ...
    */
    ...
    void Start()
    {
        ...
        _gameManager=GameManager.GetComponent<GameManager_TimeLimit_fish>();
